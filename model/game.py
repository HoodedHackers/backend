...
class Game(Base):
    ...
    def add_hand_fig(self, new_cards, discard, id):
        self.player_info[id].hand_fig = new_cards

    def remove_figure(self, id, figure):
        self.player_info[id].hand_fig.remove(figure)
